...
- [x] 1. Set up foundational protocols and dependencies
...
- [x] 2. Implement core mathematical engine in Media kit
  - [x] 2.1 Create CropGeometry.swift with constraint calculations
  ...
  - [x] 2.2 Create ImageCropRenderer.swift for final processing
  ...
  - [x] 2.3 Write comprehensive tests for mathematical invariants
...
- [x] 3. Build SwiftUI cropper interface in DesignSystem
  - [x] 3.1 Create AvatarCropperConfig.swift configuration model
    - Define all configuration parameters with sensible defaults
    - Implement Sendable and Equatable conformance
    - _Requirements: 1.1, 5.1, 5.2_
  
  - [x] 3.2 Create CropState.swift for internal state management
    - Implement ObservableObject with published properties
    - Add gesture tracking and UI state management
    - _Requirements: 2.1, 2.2, 6.1, 6.2_
  
  - [x] 3.3 Implement AvatarCropperView.swift main interface
  ...
  - [x] 3.4 Add gesture handling system
  ...
  - [x] 3.6 Create UI snapshot tests and interaction tests
    - Test Liquid Glass chrome appearance
    - Validate grid overlay positioning
    - Test gesture constraint enforcement
    - _Requirements: 3.1, 6.1, 6.2_

- [x] 4. Implement Supabase upload service
  - [x] 4.1 Create AvatarUploadServiceLive.swift
...
- [x] 6. Performance optimization and validation
  - [x] 6.1 Implement memory management optimizations
